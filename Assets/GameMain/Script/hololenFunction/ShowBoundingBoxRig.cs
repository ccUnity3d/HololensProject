...
public class ShowBoundingBoxRig : Singleton<ShowBoundingBoxRig> {
    ...
    private ShowBoundingBoxGizmoHandle[] rigScaleGizmoHandles;

    private ShowBoundingBoxGizmoHandle[] rigRotateGizmoHandles;
    ...
    private void UpdateCornerHandles()
    {
        ...
        if (cornerHandles == null)
        {
            ...
            rigScaleGizmoHandles = new ShowBoundingBoxGizmoHandle[handleCentroids.Count];
            for (int i = 0; i < cornerHandles.Length; ++i)
            {
                ...
                rigScaleGizmoHandles[i] = cornerHandles[i].AddComponent<ShowBoundingBoxGizmoHandle>();
    ...
    private void UpdateRotateHandles()
    {
        ...
        if (rotateHandles == null)
        {
            ...
            rigRotateGizmoHandles = new ShowBoundingBoxGizmoHandle[12];
            for (int i = 0; i < rotateHandles.Length; ++i)
            {
                ...
                rigRotateGizmoHandles[i] = rotateHandles[i].AddComponent<ShowBoundingBoxGizmoHandle>();
