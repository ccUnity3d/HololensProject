...
public class BumJsonTool {
    ...
    public static List<Vector3> getListVector3(Dictionary<string, object> from, string property)
    {
        object value = getValue(from, property);
        ...
        for (int i = 0; i < objs.Count; i++)
        {
            ...
            vector.DeSerialize(objs[i] as Dictionary<string, object>);
            list.Add(vector.getV3());
        }
        return list;
    }
